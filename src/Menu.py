...
def options(screen):
    ...
    #UI elements
    sliderBox  = pygame.rect.Rect(window_rect.right//1.3-20,window_rect.centery+window_rect.centery//3+4,window_rect.width//5,BUTTON_HEIGHT)
    ...
    toggleRect = pygame.rect.Rect(sliderBox.x + ((BUTTON_WIDTH//4)*DEBUGGING_MODE),sliderBox.y + BUTTON_HEIGHT*1.5,BUTTON_WIDTH//4,BUTTON_HEIGHT)
...
def mainMenu():
    ...
    #Buttons
    NEW_GAME = pygame.rect.Rect(window_rect.centerx-(BUTTON_WIDTH/2),window_rect.centery+BUTTON_HEIGHT*1.5,BUTTON_WIDTH,BUTTON_HEIGHT)
    OPTIONS  = pygame.rect.Rect(window_rect.centerx-(BUTTON_WIDTH/2),window_rect.centery+BUTTON_HEIGHT*3.0,BUTTON_WIDTH,BUTTON_HEIGHT)
    EXIT     = pygame.rect.Rect(window_rect.centerx-(BUTTON_WIDTH/2),window_rect.centery+BUTTON_HEIGHT*4.5,BUTTON_WIDTH,BUTTON_HEIGHT)
